    ...
    <ImageBackground source={background} style={styles.background}>
      <SafeAreaView style={styles.container}>
        ...
        <View>
          ...
          <Input label="EMAIL" placeholder="email" style={styles.passwordInput} />
        ...
        <View>
          <Text style={styles.newAcctext} onPress={()=>navigation.navigate('login')}>I Already have an Account</Text>
        </View>
      </SafeAreaView>
    </ImageBackground>
  )
